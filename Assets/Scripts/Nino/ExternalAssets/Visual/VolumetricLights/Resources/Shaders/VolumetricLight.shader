Shader "VolumetricLights/VolumetricLight"
{
	Properties
	{
		...
		SubShader
		{
			Tags { "RenderType" = "Transparent" "Queue" = "Transparent+100" "DisableBatching" = "True" "IgnoreProjector" = "True" }
			BlendOp [_BlendOp]
			...
			Pass
			{
				...
				v2f vert(appdata v)
				{
					...
					o.scrPos = ComputeScreenPos(o.pos);
						...
						o.pos.z = o.pos.w * UNITY_NEAR_CLIP_VALUE; // - 1.0e-6f;
					#else
